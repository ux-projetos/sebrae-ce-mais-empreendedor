  ...
  return (
    ...
    <main className="min-h-[100dvh] px-3 py-3 sm:px-4 sm:py-4 md:px-8 md:py-6">
      ...
      <div className="mx-auto flex min-h-[calc(100dvh-1.5rem)] max-w-[1700px] flex-col gap-4 sm:gap-5">
        <header className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#3B4AFF] to-[#0041D9] p-4 shadow-[0_30px_80px_-50px_rgba(0,0,0,0.9)] sm:rounded-3xl sm:p-6">
